 ...
 * @author blur
 */
public class LearnPanel1 extends BeastPanel {
    ...
    public LearnPanel1(Beast b) {
        initComponents();

        this.beast = b;
        // Significance chart

        JFreeChart sigChart = ChartFactory.createXYLineChart("Lexicon dt", // Title
                "tokens read", // x-axis Label
                "introduced tokens number", // y-axis Label
    ...
    private void initComponents() {
        ...
        jPanelGraphs.setLayout(new java.awt.GridLayout(2, 1));
        ...
        jButtonCor.setPreferredSize(new java.awt.Dimension(102, 24));
        ...
        jButtonStop.setPreferredSize(new java.awt.Dimension(102, 25));
        ...
        jLabelLex.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        ...
        jLabelCorpus.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
